...
st.title("Job Mock Interview Chatbot")
st.caption("AI-powered job mock interviews • Developed by Dipankar Dutta")
...
if not st.session_state.setup_complete:
    ...
    with col2:
        st.session_state["position"] = st.selectbox(
            "Choose a position",
            ("Data Scientist", "Data Engineer", "Software Engineer", "Analytics", "Strategy and Operations", "Consulting", "Investment Banking", "Product Management", "Sales and Marketing"),
            index=("Data Scientist", "Data Engineer", "Software Engineer", "Analytics", "Strategy and Operations", "Consulting", "Investment Banking", "Product Management", "Sales and Marketing").index(st.session_state["position"])
        )

    st.session_state["company"] = st.text_area(label="Choose a company", value=st.session_state["company"], placeholder="Enter your Target Company", max_chars=100)
...
if st.session_state.setup_complete and not st.session_state.feedback_shown and not st.session_state.chat_complete:
    ...
    # Button to end interview
    if st.button("End Interview", on_click=complete_chat, type="primary"):
        st.write("Thanks for the interview.....")
